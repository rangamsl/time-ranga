 ...
 */
final class Version20180818221756 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD num INT AUTO_INCREMENT NOT NULL, DROP id, ADD PRIMARY KEY (num)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD id INT NOT NULL, DROP num');
    }
}
